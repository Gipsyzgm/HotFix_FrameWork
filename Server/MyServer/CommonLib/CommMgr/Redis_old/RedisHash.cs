...
namespace CommonLib.Redis
{
    public partial class RedisHelper
    {
        ...
        public bool SetEntryInHash(string hashid, string key, string value)
        {
            ...
            {
                return c.SetEntryInHash(hashid, key, value);
        ...
        /// <summary>
        /// 向hashid集合中添加key/value pairs
        /// </summary>
        public void SetEntryInHash(string hashid, IEnumerable<KeyValuePair<string, string>> keyValuePairs)
        {
        ...
        public string GetValueFromHash(string hashid, string key)
        {
            ...
            using (var c = RedisManager.GetClient())
                return c.GetValueFromHash(hashid, key);
        }
        /// <summary>
