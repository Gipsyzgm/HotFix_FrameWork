...
namespace CommonLib.Redis
{
    public partial class RedisHelper
    {
        ...
        /// 添加key/value。并添加过期时间
        /// </summary>  
        public void AddToList(string key, string value, TimeSpan sp)
        {
            Core.AddItemToList(key, value);
            Core.ExpireEntryIn(key, sp);
        }
        ...
        /// 为key添加多个值
        /// </summary>  
        public void AddToList(string key, List<string> values)
        {
        ...
        /// 为key添加多个值，并设置过期时间
        /// </summary>  
        public void AddToList(string key, List<string> values, DateTime dt)
        {
            Core.AddRangeToList(key, values);
            Core.ExpireEntryAt(key, dt);
        }
        ...
        /// </summary>  
        public List<string> GetFromList(string key, int star, int end)
        {
