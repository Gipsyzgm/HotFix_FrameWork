...
namespace CSocket
{
    public class CSocketUtils
    {
        ...
        /// <returns></returns>
        public static bool CheckPortIsUse(int port, bool isTcp = true)
        {
            bool flag = false;
        ...
        /// 消息加密
        /// </summary>
        public static byte[] MD5Encrypt(ref byte[] data, int protocol)
        {
            //if(data.Length ==0)
            //    return null;
            int time = (DateTime.Now.ToTimestamp() + 300) / 600;
