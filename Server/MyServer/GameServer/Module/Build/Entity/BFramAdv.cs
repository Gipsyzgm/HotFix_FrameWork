...
namespace GameServer.Module
{
    ...
    /// 建筑-高级农场
    /// </summary>
    public class BFramAdv : Build
    {
        /// <summary>
        /// 产出类型
        /// </summary>
        public EBuildOutputType OutputType = EBuildOutputType.Food;

        public BFramAdv(Player p, TBuild data) : base(p, data)
        {
        ...
        public override void GetRes()
        {
            ...
            //{
            //    player.SendError(typeof(SC_build_getRes), "BFramAdv未到收取时间");
            //    return;
            //}
